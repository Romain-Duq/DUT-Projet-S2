...
public class Joueur {
	...
	public void mouvePersonne(int numPersonage, int pos_x, int pos_y){
		if(!(this.carte.parcelles[this.personnages.get(numPersonage).pos_x][this.personnages.get(numPersonage).pos_y].contenu instanceof Bateau)){
		...
		if(!(this.carte.parcelles[pos_x][pos_y].contenu instanceof Bateau)){
